...
main_iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(choices=['cpu', '0', '0,1,2,3'], label='Device', value='cpu', info='cuda device, i.e. 0 or 0,1,2,3 or cpu'),
...
val_iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(label="Task", choices=['train', 'val', 'test', 'speed', 'study'], value='val', info='Task to run'),
        gr.Dropdown(choices=['cpu', '0', '0,1,2,3'], label='Device', value='cpu', info='cuda device, i.e. 0 or 0,1,2,3 or cpu'),
